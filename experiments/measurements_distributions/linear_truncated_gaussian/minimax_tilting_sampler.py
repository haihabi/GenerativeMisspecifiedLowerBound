# This code was take from https://github.com/brunzema/truncated-mvn-sampler/blob/main/minimax_tilting_sampler.py
import numpy as np
import math
...
if __name__ == '__main__':
    ...
    # constraints
    lb_test = np.zeros_like(mu_test) - 0.5
    ub_test = np.ones_like(mu_test) * 0.5
